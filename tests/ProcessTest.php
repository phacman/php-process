...
use PhacMan\Process\InputStream;
...
class ProcessTest extends TestCase
{
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('"PhacMan\Process\Process::setInput" only accepts strings, Traversable objects or stream resources.');
