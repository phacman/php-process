...
use PhacMan\Process\Exception\InvalidArgumentException;
use PhacMan\Process\Exception\LogicException;
use PhacMan\Process\Exception\ProcessFailedException;
use PhacMan\Process\Exception\ProcessSignaledException;
use PhacMan\Process\Exception\ProcessTimedOutException;
use PhacMan\Process\Exception\RuntimeException;
use PhacMan\Process\Pipes\PipesInterface;
use PhacMan\Process\Pipes\UnixPipes;
use PhacMan\Process\Pipes\WindowsPipes;
use const SEEK_END;
use const STDOUT;
use Stringable;
use Traversable;
...
class Process implements IteratorAggregate
{
    ...
    public function start(callable $callback = null, array $env = []) : void
    {
        ...
        if (is_array($commandline = $this->commandline)) {
            ...
            $commandline = $this->replacePlaceholders((string) $commandline, $env);
        }
     ...
     * @throws RuntimeException In case of failure
     */
    private function doSignal(int $signal, bool $throwException) : void
    {
